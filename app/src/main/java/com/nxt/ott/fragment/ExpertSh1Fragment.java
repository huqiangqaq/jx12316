...
/**
 * Created by huqiang on 2017/4/26 9:21.
 */

public class ExpertSh1Fragment extends ZBaseFragment implements HttpCallback, AdapterView.OnItemSelectedListener,SwipeRefreshLayout.OnRefreshListener {
...
//        initTopbar(this, getString(R.string.ask_expert));
        ...
        mlistview = (ListView) view.findViewById(R.id.listview_expert);
        ...
        spCityChoose = (CustomSpinner) view.findViewById(R.id.sp_city);
        spCountryChoose = (CustomSpinner)view.findViewById(R.id.sp_country);
        spExpertTypeChoose = (CustomSpinner) view.findViewById(R.id.sp_expert_type);
                    ...
                    public void onResponse(String response, int id) {
                        if (response != null) {
                            ...
                            try {
                                ...
                                experterAdapter = new ExperterAdapter(getActivity(),experterList);
    ...
    public void onRequestResult(String string) {
        ...
        if (TAG == 2) {
            ...
            city_adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, listCityName);
            ...
            county_adapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, listCountryName);
            ...
            experter_adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, listExpertTypeName);
            ...
            try {
                ...
                if (page == 1) {
                    ...
                    if (addlist.size() > 0) {
                        ...
                        ZToastUtils.showShort(getActivity(), R.string.expert_is_over);
                    }
                }
            } catch (JSONException e) {
                e.printStackTrace();
        ...
        switch (parent.getId()) {
            ...
            case R.id.sp_country:
                if ("请选择地市".equals(listCityName)) {
                    ...
                    ToastUtils.showShort(getActivity(), "请先选择一个地市");
                } else {
                    if (position != 0) {
                        areatype = 3;
