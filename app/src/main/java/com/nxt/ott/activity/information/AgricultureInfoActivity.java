...
package com.nxt.ott.activity.information;
...
import com.nxt.ott.fragment.NewsItemFragment;
 ...
 */
public class AgricultureInfoActivity extends BaseTitleActivity {
...
//        urllist.add(Constant.AGRICULTURE_NEWS_URL);
        ...
        titles = Arrays.asList(getResources().getStringArray(R.array.agriculture_info_list));
        //viewpager加载adapter
        MyFragmentAdapter adapter = new MyFragmentAdapter(getSupportFragmentManager());
        for (int i = 0; i < titles.size(); i++) {
            Log.e("Seed-47", "size-------------->" + titles.size());
            adapter.addFragment(NewsItemFragment.newInstance(i, 0), titles.get(i));//0为分类标识
        }
    ...
    protected int getLayout() {
        return R.layout.activity_agriculture_info;
    }
